...
class Environment:
    ...
    def GenerateChromosomes(self, sequence):
        chromosomes = []
        chromosomes.append(Chromosome(sequence, 'Mu', 16, 20, 35.0))
        chromosomes.append(Chromosome(sequence, 'Ms', 24, 350.0, 500.0))
        chromosomes.append(Chromosome(sequence, 'Kt', 24, 50000.0, 80000.0))
        chromosomes.append(Chromosome(sequence, 'K', 24, 60000.0, 80000.0))
        chromosomes.append(Chromosome(sequence, 'C', 24, 1500.0, 2700.0))
        return chromosomes
